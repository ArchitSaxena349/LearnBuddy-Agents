    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-semibold mb-4">The Imperials</h3>
            <p className="text-gray-400">Where AI, Gamification, and AR Redefine Learning
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/cookies" className="text-gray-400 hover:text-white transition duration-300">Cookie Policy</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">&copy; {new Date().getFullYear()} The Imperials. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
